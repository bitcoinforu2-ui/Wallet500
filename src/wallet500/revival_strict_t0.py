...
def lock_or_read_strict_t0(state: dict, coin: dict, observed_at: str) -> tuple[dict | None, bool]:
    ...
    if created:
        ...
        records[key] = {
            ...
            "strict_strength_score_at_discovery": flow.get("strict_strength_score"),
...
def enrich_payload(payload: dict, state: dict, observed_at: str | None = None) -> tuple[dict, dict]:
    ...
    for coin in payload.get("coins") or []:
        ...
        coin["strict_discovery"] = {
            ...
            "strict_grade_at_discovery": record.get("strict_grade_at_discovery"),
            "strict_level_at_discovery": record.get("strict_level_at_discovery"),
            "strict_strength_score_at_discovery": record.get("strict_strength_score_at_discovery"),
    ...
    payload["strict_discovery_contract"] = {
        ...
        "discovery_strength_mutation": "FORBIDDEN_AFTER_FIRST_LOCK",
        "no_hindsight": True,
