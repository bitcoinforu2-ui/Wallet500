...
CANONICAL_REAL_ALERT_SCORE_THRESHOLD = 85.0
...
def canonical_policy() -> dict:
    return {
        ...
        "real_alert_score_threshold": CANONICAL_REAL_ALERT_SCORE_THRESHOLD,
...
def policy_matches_exactly(policy: dict | None) -> bool:
    ...
    try:
        ...
        score_threshold = float(policy.get("real_alert_score_threshold", CANONICAL_REAL_ALERT_SCORE_THRESHOLD))
    except (TypeError, ValueError):
        return False
    return (
        age == CANONICAL_MIN_MARKET_AGE_DAYS
        and liquidity == CANONICAL_MIN_EXECUTION_LIQUIDITY_USD
        and score_threshold == CANONICAL_REAL_ALERT_SCORE_THRESHOLD
