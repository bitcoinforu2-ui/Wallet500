...
def run():
    ...
    summary['catalyst_dna']={'profiles':dna.get('profiles_count',0),'market_profiles':dna.get('market_profiles_count',dna.get('profiles_count',0)),'unique_symbols':dna.get('unique_symbols_count',0),'consensus_symbols':len(dna.get('consensus_profiles',[]) or []),'source_attribution_sources':len(dna.get('source_attribution',{})),'archetypes':len(dna.get('archetype_frequency',{})),'counting_rule':dna.get('counting_rule')}
