...
def run():
    ...
    summary['intelligence_policy']={'mode':'OLD_COIN_REVIVAL_FIRST','production_primary':'ESTABLISHED_TOKEN_REVIVAL','new_token_lane':'RESEARCH_ONLY','social_lane':'CATALYST_DISCOVERY_RESEARCH','target_attention_pct':{'old_coin_revival':90,'new_token_research':10},'old_coin_min_age_days':7,'preferred_old_coin_age_days':30,'new_token_research_only_hours':48,'minimum_exchange_confirmations':2,'strong_exchange_confirmations':4}
