...
def run():
    ...
    summary['cex_revival_alerts']=cex.get('alerts_count',0);summary['updated_at']=now;summary['mode']='OLD_COIN_REVIVAL_FIRST_90+1H_CENSUS+CATALYST_DNA+TIME_MACHINE+SOCIAL_CATALYST+NEW_TOKEN_LAB_10';_write(summary_path,summary)
