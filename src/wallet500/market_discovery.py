...
def _get(url:str,timeout:int=20,retries:int=3):
    ...
    for attempt in range(max(1,retries)):
        try:
            req=Request(url,headers={"Accept":"application/json","User-Agent":"Wallet500/0.4"})
    ...
    for chain in wanted:
        ...
        for page in pages:
            ...
            try:
                ...
                continue
        # Never publish a false zero just because a rotated page batch was empty/transiently blocked.
        # If this chain contributed nothing, retry the freshest pages immediately.
