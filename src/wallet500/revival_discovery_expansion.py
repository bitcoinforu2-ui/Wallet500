...
def main() -> None:
    ...
    payload["universe_definition"] = (
        "COINGECKO SOLANA-ONLY BASE PLUS ALL CURRENT ABSORPTION-SIGNAL TOKENS FROM THE PERSISTED SOLANA REVIVAL DISCOVERY STATE; NO FIXED TOTAL CANDIDATE CAP; DISCOVERY PAIRS MUST BE AT LEAST 90 DAYS OLD"
    )
