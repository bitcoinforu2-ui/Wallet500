...
def test_multi_signal_can_be_hot_but_never_production():
    social = {"scores": {"narrative": 80, "social_momentum": 75, "kol_quality": 55, "news_catalyst": 60, "hype_manipulation_risk": 5}, "organic": {"acceleration_vs_prior_6h": 3.0}}
...
def test_hard_blocker_cannot_be_overridden_by_social():
    ...
    social = {"scores": {"narrative": 100, "social_momentum": 100, "kol_quality": 100, "news_catalyst": 100, "hype_manipulation_risk": 0}}
