    ...
    return {
        ...
        "decision_snapshot": {
            "entry": {
                ...
                "verified_execution_liquidity_usd": 100000,
            }
        },
        "checkpoints": {
            "6h": {"friction_adjusted_return_pct": 23.0}
        },
