...
def dynamic_candidates(persisted_tokens=None):
        ...
        out.append(
            {
                ...
                "asset_identity_key": c.get("asset_identity_key"),
                "multi_pool_watch": bool(c.get("multi_pool_watch")),
                "asset_pool_rank": c.get("asset_pool_rank"),
                "asset_pool_role": c.get("asset_pool_role"),
                "asset_pool_count": c.get("asset_pool_count"),
    ...
    for prev in (persisted_tokens or {}).values():
        ...
        out.append({
            ...
            "asset_identity_key": prev.get("asset_identity_key"),
            "multi_pool_watch": bool(prev.get("multi_pool_watch")),
            "asset_pool_rank": prev.get("asset_pool_rank"),
            "asset_pool_role": prev.get("asset_pool_role"),
            "asset_pool_count": prev.get("asset_pool_count"),
            "asset_total_dex_liquidity_usd": prev.get("asset_total_dex_liquidity_usd"),
...
def main():
    ...
    for token_index, t in enumerate(tokens):
        ...
        current_state = {
            ...
            "candidate_type": t.get("candidate_type") or "CONFIGURED",
            "asset_identity_key": t.get("asset_identity_key"),
            "multi_pool_watch": bool(t.get("multi_pool_watch")),
            "asset_pool_rank": t.get("asset_pool_rank"),
            "asset_pool_role": t.get("asset_pool_role"),
            "asset_pool_count": t.get("asset_pool_count"),
